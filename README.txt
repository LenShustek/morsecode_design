...
accepts a multi-panel description of areas to contain the message. You 
can also specify restricted areas where no message is placed, which I 
used to leave room for the lockset and the intercom. 
